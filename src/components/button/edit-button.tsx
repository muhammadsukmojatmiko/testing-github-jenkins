...
import { RefineEditButtonProps } from "./button-types";
import { Button, ButtonProps, SvgIconProps } from "@mui/material";
import EditOutlinedIcon from "@mui/icons-material/EditOutlined";

export type AgEditButtonProps = RefineEditButtonProps<
  ButtonProps,
  {
...
/**
 * `<EditButton>` uses Material UI {@link https://mui.com/components/buttons/ `<Button>`} component.
 ...
 */
export const AgEditButton: React.FC<AgEditButtonProps> = ({
  ...
  return (
    ...
    >
      <Button
        ...
        startIcon={
          !hideText && (
            <EditOutlinedIcon sx={{ selfAlign: "center" }} {...svgIconProps} />
          )
        }
        title={disabledTitle()}
        sx={{ minWidth: 0, ...sx }}
        data-testid={"edit-button"} // TODO
        {...restProps}
      >
        {hideText ? (
